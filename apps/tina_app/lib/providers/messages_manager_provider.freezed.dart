...
mixin _$StreamingMessage {
 ...
 String get messageId; String get conversationId; String get responseMesageId; String get content; MessageMetadataEntity? get metadata; DateTime get createdAt; DateTime get updatedAt; StreamingMessageStatus get status; List<ToolCallMessageItem>? get toolCalls;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is StreamingMessage&&(identical(other.messageId, messageId) || other.messageId == messageId)&&(identical(other.conversationId, conversationId) || other.conversationId == conversationId)&&(identical(other.responseMesageId, responseMesageId) || other.responseMesageId == responseMesageId)&&(identical(other.content, content) || other.content == content)&&(identical(other.metadata, metadata) || other.metadata == metadata)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt)&&(identical(other.status, status) || other.status == status)&&const DeepCollectionEquality().equals(other.toolCalls, toolCalls));
}


@override
int get hashCode => Object.hash(runtimeType,messageId,conversationId,responseMesageId,content,metadata,createdAt,updatedAt,status,const DeepCollectionEquality().hash(toolCalls));

@override
String toString() {
  return 'StreamingMessage(messageId: $messageId, conversationId: $conversationId, responseMesageId: $responseMesageId, content: $content, metadata: $metadata, createdAt: $createdAt, updatedAt: $updatedAt, status: $status, toolCalls: $toolCalls)';
}
...
@useResult
$Res call({
 String messageId, String conversationId, String responseMesageId, String content, MessageMetadataEntity? metadata, DateTime createdAt, DateTime updatedAt, StreamingMessageStatus status, List<ToolCallMessageItem>? toolCalls
});
...
/// Create a copy of StreamingMessage
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? messageId = null,Object? conversationId = null,Object? responseMesageId = null,Object? content = null,Object? metadata = freezed,Object? createdAt = null,Object? updatedAt = null,Object? status = null,Object? toolCalls = freezed,}) {
  return _then(_self.copyWith(
...
as StreamingMessageStatus,toolCalls: freezed == toolCalls ? _self.toolCalls : toolCalls // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String messageId,  String conversationId,  String responseMesageId,  String content,  MessageMetadataEntity? metadata,  DateTime createdAt,  DateTime updatedAt,  StreamingMessageStatus status,  List<ToolCallMessageItem>? toolCalls)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _StreamingMessage() when $default != null:
return $default(_that.messageId,_that.conversationId,_that.responseMesageId,_that.content,_that.metadata,_that.createdAt,_that.updatedAt,_that.status,_that.toolCalls);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String messageId,  String conversationId,  String responseMesageId,  String content,  MessageMetadataEntity? metadata,  DateTime createdAt,  DateTime updatedAt,  StreamingMessageStatus status,  List<ToolCallMessageItem>? toolCalls)  $default,) {final _that = this;
switch (_that) {
case _StreamingMessage():
return $default(_that.messageId,_that.conversationId,_that.responseMesageId,_that.content,_that.metadata,_that.createdAt,_that.updatedAt,_that.status,_that.toolCalls);case _:
  throw StateError('Unexpected subclass');
...
class _StreamingMessage implements StreamingMessage {
  const _StreamingMessage({required this.messageId, required this.conversationId, required this.responseMesageId, required this.content, this.metadata, required this.createdAt, required this.updatedAt, required this.status, final  List<ToolCallMessageItem>? toolCalls}): _toolCalls = toolCalls;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _StreamingMessage&&(identical(other.messageId, messageId) || other.messageId == messageId)&&(identical(other.conversationId, conversationId) || other.conversationId == conversationId)&&(identical(other.responseMesageId, responseMesageId) || other.responseMesageId == responseMesageId)&&(identical(other.content, content) || other.content == content)&&(identical(other.metadata, metadata) || other.metadata == metadata)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt)&&(identical(other.status, status) || other.status == status)&&const DeepCollectionEquality().equals(other._toolCalls, _toolCalls));
}


@override
int get hashCode => Object.hash(runtimeType,messageId,conversationId,responseMesageId,content,metadata,createdAt,updatedAt,status,const DeepCollectionEquality().hash(_toolCalls));
...
/// Create a copy of StreamingMessage
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? messageId = null,Object? conversationId = null,Object? responseMesageId = null,Object? content = null,Object? metadata = freezed,Object? createdAt = null,Object? updatedAt = null,Object? status = null,Object? toolCalls = freezed,}) {
...
as DateTime,updatedAt: null == updatedAt ? _self.updatedAt : updatedAt // ignore: cast_nullable_to_non_nullable
as DateTime,status: null == status ? _self.status : status // ignore: cast_nullable_to_non_nullable
as StreamingMessageStatus,toolCalls: freezed == toolCalls ? _self._toolCalls : toolCalls // ignore: cast_nullable_to_non_nullable
as List<ToolCallMessageItem>?,
  ));
}
