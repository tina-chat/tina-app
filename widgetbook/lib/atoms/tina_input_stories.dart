...
Widget inputStatesUseCase(BuildContext context) {
  return const Padding(
    ...
    child: Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        TinaText('Normal State', style: TinaTextStyle.caption),
        SizedBox(height: 8),
        TinaInput(
        ...
        SizedBox(height: 24),
        TinaText('Success State', style: TinaTextStyle.caption),
        SizedBox(height: 8),
        TinaInput(
          state: TinaInputState.success,
          placeholder: 'Success input',
          helperText: 'Input validation successful',
          initialValue: 'Valid input',
        ),
        SizedBox(height: 24),
        TinaText('Warning State', style: TinaTextStyle.caption),
        SizedBox(height: 8),
        TinaInput(
        ...
        SizedBox(height: 24),
        TinaText('Error State', style: TinaTextStyle.caption),
        SizedBox(height: 8),
        TinaInput(
    ...
    child: Column(
      ...
      children: const [
        TinaInput(
          ...
          helperText: 'Input with prefix icon',
        ),
        SizedBox(height: 24),
        TinaInput(
          placeholder: 'Enter password',
          suffixIcon: Icon(Icons.visibility_off),
          helperText: 'Input with suffix icon',
          obscureText: true,
        ),
        SizedBox(height: 24),
        TinaInput(
          ...
          helperText: 'Input with both prefix and suffix icons',
        ),
      ],
    ),
  );
    ...
    child: Column(
      ...
      children: [
        TinaInput(
          ...
          helperText: 'Email input type',
        ),
        SizedBox(height: 24),
        TinaInput(
          placeholder: 'Enter phone number',
          keyboardType: TextInputType.phone,
          helperText: 'Phone input type',
        ),
        SizedBox(height: 24),
        TinaInput(
          placeholder: 'Enter a number',
          keyboardType: TextInputType.number,
          helperText: 'Number input type',
        ),
        SizedBox(height: 24),
        TinaInput(
          placeholder: 'Enter password',
          obscureText: true,
          helperText: 'Password input (obscured)',
        ),
      ],
    ),
  );
    ...
    child: Column(
      ...
      children: [
        ...
        TinaInput(
          ...
          maxLines: 3,
          maxLength: 200,
          helperText: 'Multiline with character limit',
        ),
      ],
    ),
  );
    ...
    child: Column(
      ...
      children: [
        TinaInput(
          ...
          helperText: 'Converts input to uppercase',
        ),
        ...
        TinaInput(
          ...
          helperText: 'Limited to 10 characters',
        ),
      ],
    ),
  );
    ...
    child: Column(
      ...
      children: [
        ...
        TinaInput(
          ...
          helperText: 'Disabled input with initial value',
        ),
        SizedBox(height: 24),
        TinaInput(
          readOnly: true,
    ...
    child: Column(
      ...
      children: [
        TinaInput(
          ...
          helperText: 'This input is auto-focused',
        ),
        SizedBox(height: 24),
        TinaInput(
          placeholder: 'Regular input',
          helperText: 'Regular input field',
        ),
        SizedBox(height: 24),
        TinaInput(
          placeholder: 'Another input',
          helperText: 'Another input field',
        ),
      ],
    ),
  );
    ...
    child: Column(
      ...
      children: [
        ...
        TinaInput(
          ...
          helperText: 'Tap this field to see interaction',
        ),
      ],
    ),
  );
